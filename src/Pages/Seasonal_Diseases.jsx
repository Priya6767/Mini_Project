          ...
          <main className="flex-1 py-10 px-6 md:px-14">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition">
                ...
                <button
                  className="text-xl font-bold mb-4 text-center text-white bg-red-500 hover:bg-red-600 w-full rounded transition"
                ...
                {showSummer && (
                  <div className="mt-3">
                    <label htmlFor="summer-select" className="block mb-2 text-sm font-medium text-gray-700">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition">
                ...
                {showMonsoon && (
                  <div className="mt-3">
                    <label htmlFor="monsoon-select" className="block mb-2 text-sm font-medium text-gray-700">
              ...
              <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition">
                ...
                {showWinter && (
                  <div className="mt-3">
                    <label htmlFor="winter-select" className="block mb-2 text-sm font-medium text-gray-700">
